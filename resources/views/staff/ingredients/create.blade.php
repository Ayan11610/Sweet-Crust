...
<head>
    ...
    <title>Add Ingredient - Sweet Crust</title>
...
<body>
    ...
    <div class="container" style="padding:60px 20px;">
        <h1 style="margin-bottom:40px;color:#d4a574;"><i class="fas fa-plus"></i> Add New Ingredient</h1>
        ...
        <div class="card" style="max-width:800px;margin:0 auto;">
            <form method="POST" action="{{ route('ingredients.store') }}">
                ...
                <div style="margin-bottom:20px;">
                    ...
                    <input type="text" name="ingredientName" value="{{ old('ingredientName') }}" required 
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-bottom:20px;">
                    ...
                    <div>
                        ...
                        <input type="number" name="quantityInStock" value="{{ old('quantityInStock') }}" min="0" step="0.01" required 
                               style="width:100%;padding:10px;border:1px solid #ddd;border-radius:4px;">
                    </div>
                </div>
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-bottom:20px;">
                    <div>
                        ...
                        <input type="number" name="reorderLevel" value="{{ old('reorderLevel') }}" min="0" step="0.01" required 
                               style="width:100%;padding:10px;border:1px solid #ddd;border-radius:4px;">
                    ...
                    <div>
                        ...
                        <input type="number" name="pricePerUnit" value="{{ old('pricePerUnit') }}" min="0" step="0.01" required 
                               style="width:100%;padding:10px;border:1px solid #ddd;border-radius:4px;">
                    </div>
                </div>
